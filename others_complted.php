...
<body>
  <div class="sidebar">
   ...
   <ul class="nav-links">
      ...
      <li>
        <a href="admin_other_filters.php">
          <i class='bx bx-pie-chart-alt'></i>
          <span class="links_name">Data Analytics</span>
        </a>
      </li>
      <li>
        <a href="others_complted.php" class="active">
...
$sql = "SELECT id, name, department, type,iname, date FROM others";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <td>" .$cnt. "</td>
                ...
                <td>" . $row['type'] . "</td>
                 <td>" . $row['iname'] . "</td>
                <td>" . $row['date'] . "</td>
                <td><a href='view_other_data.php?id=" . $row['id'] . "'>View</a></td>
              </tr>";
              $cnt++;
    }
    echo "</table>";
