  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Comleted Data</span>
      </div>
...
$sql = "SELECT id, name, department, type,iname, date FROM others  WHERE user_id = $userId";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <td>" . $cnt . "</td>
                ...
                <td>" . $row['iname'] . "</td>
                <td>" . $row['date'] . "</td>
                <td><a href='view_user_other_data.php?id=" . $row['id'] . "'>View</a></td>
              </tr>";
              $cnt++;
    }
    echo "</table>";
