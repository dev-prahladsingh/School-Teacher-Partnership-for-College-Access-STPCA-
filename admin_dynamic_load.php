...
<body>
  ...
  <div class="sidebar">
   ...
   <ul class="nav-links">
      ...
      <li>
        <a href="admin.php" id="redirect-link1">
          <i class='bx bx-envelope'></i>
          <span class="links_name">Deeksha</span>
        </a>
      </li>
        <li>
        <a href="others_admin.php" id="redirect-link2">
<i class='bx bx-star'></i>
          <span class="links_name">Others</span>
        </a>
      </li>
        <li>
        <a href="add_admin.php" id="redirect-link3">
          <i class='bx bx-bar-chart'></i>
          <span class="links_name">Admission</span>
        </a>
      </li>
       <li>
        <a href="admin_dynamic_load.php" class="active" >
          <i class='bx bx-calendar-check'></i>
          <span class="links_name">Analytics</span>
        </a>
      </li>
       <li>
        <a href="all_users.php" id="redirect-link3">
<i class='bx bx-cog'></i>
...
<center>
 ...
 <select id="contentSelector" onchange="redirectToPage()">
        ...
        <option value="analytics">Deeksha</option>
        <option value="admin_other_filters">Others</option>
        <option value="students/upload">Admission</option>
